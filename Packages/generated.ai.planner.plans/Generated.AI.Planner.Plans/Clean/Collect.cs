...
namespace Generated.AI.Planner.Plans.Clean
{
    ...
    struct Collect : IJobParallelForDefer
    {
        ...
        {
            var RobotFilter = new NativeArray<ComponentType>(3, Allocator.Temp){[0] = ComponentType.ReadWrite<Unity.AI.Planner.DomainLanguage.TraitBased.Location>(),[1] = ComponentType.ReadWrite<Generated.AI.Planner.StateRepresentation.Robot>(),[2] = ComponentType.ReadWrite<Generated.AI.Planner.StateRepresentation.Cleanliness>(),  };
            ...
            for (int i0 = 0; i0 < RobotObjectIndices.Length; i0++)
            {
                ...
                if (!(RobotBuffer[RobotObject.RobotIndex].Battery >= 10))
                    continue;
