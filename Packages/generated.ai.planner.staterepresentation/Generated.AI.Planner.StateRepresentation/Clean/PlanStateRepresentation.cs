...
namespace Generated.AI.Planner.StateRepresentation.Clean
{
    ...
    public static class TraitArrayIndex<T> where T : struct, ITrait
    {
        ...
        static TraitArrayIndex()
        {
            ...
            if (typeIndex == TypeManager.GetTypeIndex<Robot>())
                ...
                Index = 1;
            else if (typeIndex == TypeManager.GetTypeIndex<ChargingStation>())
                Index = 2;
            else if (typeIndex == TypeManager.GetTypeIndex<Cleanliness>())
                Index = 3;
    ...
    public struct TraitBasedObject : ITraitBasedObject
    {
        ...
        public byte this[int i]
        {
            get
            {
                switch (i)
                {
                    ...
                    case 2:
                        return ChargingStationIndex;
                    case 3:
                        return CleanlinessIndex;
                    case 4:
                        return DirtIndex;
                    case 5:
            ...
            set
            {
                switch (i)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        ChargingStationIndex = value;
                        break;
                    case 3:
                        CleanlinessIndex = value;
                        break;
                    case 4:
                        DirtIndex = value;
                        break;
        ...
        public static TraitBasedObject Default => new TraitBasedObject
        {
            RobotIndex = Unset,
            LocationIndex = Unset,
            ChargingStationIndex = Unset,
            CleanlinessIndex = Unset,
            DirtIndex = Unset,
            MoveableIndex = Unset,
        };
        ...
        public byte ChargingStationIndex;
        public byte CleanlinessIndex;
        ...
        static readonly int s_ChargingStationTypeIndex = TypeManager.GetTypeIndex<ChargingStation>();
        static readonly int s_CleanlinessTypeIndex = TypeManager.GetTypeIndex<Cleanliness>();
        ...
        public bool MatchesTraitFilter(NativeArray<ComponentType> componentTypes)
        {
            for (int i = 0; i < componentTypes.Length; i++)
            {
                ...
                else if (t.TypeIndex == s_ChargingStationTypeIndex)
                {
                    if (t.AccessModeType == ComponentType.AccessMode.Exclude ^ ChargingStationIndex == Unset)
                        return false;
                }
                else if (t.TypeIndex == s_CleanlinessTypeIndex)
                {
                    if (t.AccessModeType == ComponentType.AccessMode.Exclude ^ CleanlinessIndex == Unset)
                        return false;
                }
    ...
    public struct StateData : ITraitBasedStateData<TraitBasedObject, StateData>
    {
        ...
        public DynamicBuffer<ChargingStation> ChargingStationBuffer;
        public DynamicBuffer<Cleanliness> CleanlinessBuffer;
        ...
        public StateData(JobComponentSystem system, Entity stateEntity, bool readWrite = false)
        {
            ...
            ChargingStationBuffer = system.GetBufferFromEntity<ChargingStation>(!readWrite)[stateEntity];
            CleanlinessBuffer = system.GetBufferFromEntity<Cleanliness>(!readWrite)[stateEntity];
        ...
        public StateData(int jobIndex, EntityCommandBuffer.Concurrent entityCommandBuffer, Entity stateEntity)
        {
            ...
            ChargingStationBuffer = entityCommandBuffer.AddBuffer<ChargingStation>(jobIndex, stateEntity);
            CleanlinessBuffer = entityCommandBuffer.AddBuffer<Cleanliness>(jobIndex, stateEntity);
        ...
        public StateData Copy(int jobIndex, EntityCommandBuffer.Concurrent entityCommandBuffer)
        {
            ...
            var ChargingStations = entityCommandBuffer.SetBuffer<ChargingStation>(jobIndex, stateEntity);
            ChargingStations.CopyFrom(ChargingStationBuffer.AsNativeArray());
            var Cleanlinesss = entityCommandBuffer.SetBuffer<Cleanliness>(jobIndex, stateEntity);
            Cleanlinesss.CopyFrom(CleanlinessBuffer.AsNativeArray());
            ...
            return new StateData
            {
                ...
                ChargingStationBuffer = ChargingStations,
                CleanlinessBuffer = Cleanlinesss,
                DirtBuffer = Dirts,
        ...
        public void AddObject(NativeArray<ComponentType> types, out TraitBasedObject traitBasedObject, TraitBasedObjectId objectId, NativeString64 name = default)
        {
            ...
            for (int i = 0; i < types.Length; i++)
            {
                ...
                {
                    ChargingStationBuffer.Add(default);
                    traitBasedObject.ChargingStationIndex = (byte) (ChargingStationBuffer.Length - 1);
                }
                else if (t.TypeIndex == s_CleanlinessTypeIndex)
                {
                    CleanlinessBuffer.Add(default);
                    traitBasedObject.CleanlinessIndex = (byte) (CleanlinessBuffer.Length - 1);
                }
                else if (t.TypeIndex == s_DirtTypeIndex)
                {
        ...
        public void SetTraitOnObject(ITrait trait, ref TraitBasedObject traitBasedObject)
        {
            ...
            else if (trait is ChargingStation ChargingStationTrait)
                SetTraitOnObject(ChargingStationTrait, ref traitBasedObject);
            else if (trait is Cleanliness CleanlinessTrait)
                SetTraitOnObject(CleanlinessTrait, ref traitBasedObject);
        ...
        public void SetTraitOnObjectAtIndex(ITrait trait, int traitBasedObjectIndex)
        {
            if (trait is Robot RobotTrait)
                ...
                SetTraitOnObjectAtIndex(ChargingStationTrait, traitBasedObjectIndex);
            else if (trait is Cleanliness CleanlinessTrait)
                SetTraitOnObjectAtIndex(CleanlinessTrait, traitBasedObjectIndex);
            else if (trait is Dirt DirtTrait)
        ...
        public bool RemoveObject(TraitBasedObject traitBasedObject)
        {
            ...
            RemoveTraitOnObject<ChargingStation>(ref traitBasedObject);
            RemoveTraitOnObject<Cleanliness>(ref traitBasedObject);
        ...
        public bool RemoveTraitBasedObjectAtIndex(int traitBasedObjectIndex)
        {
            ...
            RemoveTraitOnObjectAtIndex<ChargingStation>(traitBasedObjectIndex);
            RemoveTraitOnObjectAtIndex<Cleanliness>(traitBasedObjectIndex);
        ...
        DynamicBuffer<T> GetBuffer<T>() where T : struct, ITrait
        {
            ...
            switch (index)
            {
                ...
                case 2:
                    return ChargingStationBuffer.Reinterpret<T>();
                case 3:
                    return CleanlinessBuffer.Reinterpret<T>();
                case 4:
        ...
        public bool Equals(StateData rhsState)
        {
            ...
            if (TraitBasedObjects.Length != rhsState.TraitBasedObjects.Length
                ...
                || ChargingStationBuffer.Length != rhsState.ChargingStationBuffer.Length
                || CleanlinessBuffer.Length != rhsState.CleanlinessBuffer.Length
        ...
        bool ObjectsMatchAttributes(TraitBasedObject traitBasedObjectLHS, TraitBasedObject traitBasedObjectRHS, StateData rhsState)
        {
            ...
            if (traitBasedObjectLHS.RobotIndex != TraitBasedObject.Unset
                && !RobotTraitAttributesEqual(RobotBuffer[traitBasedObjectLHS.RobotIndex], rhsState.RobotBuffer[traitBasedObjectRHS.RobotIndex]))
                return false;
            ...
            if (traitBasedObjectLHS.CleanlinessIndex != TraitBasedObject.Unset
                && !CleanlinessTraitAttributesEqual(CleanlinessBuffer[traitBasedObjectLHS.CleanlinessIndex], rhsState.CleanlinessBuffer[traitBasedObjectRHS.CleanlinessIndex]))
                return false;
        ...
        bool RobotTraitAttributesEqual(Robot one, Robot two)
        {
            return
                    one.Battery == two.Battery;
        }
        ...
        bool CleanlinessTraitAttributesEqual(Cleanliness one, Cleanliness two)
        {
            return
                    one.DirtCount == two.DirtCount;
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var element = RobotBuffer[i];
                var value = 397
                    ^ element.Battery.GetHashCode();
            ...
            for (int i = 0; i < ChargingStationBuffer.Length; i++)
            {
                var value = 397;
                stateHashValue = 3860031 + (stateHashValue + value) * 2779 + (stateHashValue * value * 2);
            }
            for (int i = 0; i < CleanlinessBuffer.Length; i++)
            {
                var element = CleanlinessBuffer[i];
                var value = 397
                    ^ element.DirtCount.GetHashCode();
                stateHashValue = 3860031 + (stateHashValue + value) * 2779 + (stateHashValue * value * 2);
            }
        ...
        public override string ToString()
        {
            ...
            for (var traitBasedObjectIndex = 0; traitBasedObjectIndex < TraitBasedObjects.Length; traitBasedObjectIndex++)
            {
                ...
                traitIndex = traitBasedObject[i++];
                if (traitIndex != TraitBasedObject.Unset)
                    sb.AppendLine(ChargingStationBuffer[traitIndex].ToString());

                traitIndex = traitBasedObject[i++];
                if (traitIndex != TraitBasedObject.Unset)
                    sb.AppendLine(CleanlinessBuffer[traitIndex].ToString());
    ...
    public struct StateDataContext : ITraitBasedStateDataContext<TraitBasedObject, StateEntityKey, StateData>
    {
        ...
        [ReadOnly] public BufferFromEntity<ChargingStation> ChargingStationData;
        [ReadOnly] public BufferFromEntity<Cleanliness> CleanlinessData;
        ...
        public StateDataContext(JobComponentSystem system, EntityArchetype stateArchetype)
        {
            ...
            ChargingStationData = system.GetBufferFromEntity<ChargingStation>(true);
            CleanlinessData = system.GetBufferFromEntity<Cleanliness>(true);
        ...
        public StateData GetStateData(StateEntityKey stateKey)
        {
            ...
            return new StateData
            {
                ...
                ChargingStationBuffer = ChargingStationData[stateEntity],
                CleanlinessBuffer = CleanlinessData[stateEntity],
